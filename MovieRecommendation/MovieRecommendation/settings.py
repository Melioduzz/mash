...
SECRET_KEY = 'django-insecure-g=cfbm+r)m7d1!0^*b8$s32&rr@x3qif)dl6q6f8qzj$8umv)6'
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'width': '100%',  # Example additional configuration
        'height': 300,     # Example additional configuration
        # Add other CKEditor configurations as needed
    }
}
